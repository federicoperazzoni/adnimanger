...
public class FAQManager {
	...
	public void insertInADNIOntology(ArrayList<FAQBean> faqTestList) {
		...
		for (FAQBean faqBean : faqTestList) {
			...
			LoadCsv.loadPercent = ((40*count)/total) + 60;
		}
